package org.scaleadvisor.backend.project.controller.response.cocomoscalefactor

import org.scaleadvisor.backend.project.domain.CocomoScaleFactor
import java.time.LocalDateTime

data class CreateCocomoScaleFactorResponse(
    val id: String,
    ...
    companion object {
        @JvmStatic
        fun from(scaleFactor: CocomoScaleFactor): CreateCocomoScaleFactorResponse {
            return CreateCocomoScaleFactorResponse(
