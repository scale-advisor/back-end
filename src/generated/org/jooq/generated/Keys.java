...
public class Keys {
    ...
    public static final UniqueKey<RequirementCategoryRecord> KEY_REQUIREMENT_CATEGORY_PRIMARY = Internal.createUniqueKey(RequirementCategory.REQUIREMENT_CATEGORY, DSL.name("KEY_REQUIREMENT_CATEGORY_PRIMARY"), new TableField[] { RequirementCategory.REQUIREMENT_CATEGORY.REQUIREMENT_CATEGORY_ID }, true);
    public static final UniqueKey<RequirementUnitProcessRecord> KEY_REQUIREMENT_UNIT_PROCESS_PRIMARY = Internal.createUniqueKey(RequirementUnitProcess.REQUIREMENT_UNIT_PROCESS, DSL.name("KEY_REQUIREMENT_UNIT_PROCESS_PRIMARY"), new TableField[] { RequirementUnitProcess.REQUIREMENT_UNIT_PROCESS.REQUIREMENT_UNIT_PROCESS_ID }, true);
    ...
    public static final ForeignKey<RequirementCategoryRecord, VersionRecord> FK_REQUIREMENT_CATEGORY_VERSION = Internal.createForeignKey(RequirementCategory.REQUIREMENT_CATEGORY, DSL.name("FK_REQUIREMENT_CATEGORY_VERSION"), new TableField[] { RequirementCategory.REQUIREMENT_CATEGORY.PROJECT_ID, RequirementCategory.REQUIREMENT_CATEGORY.VERSION_MAJOR_NUMBER, RequirementCategory.REQUIREMENT_CATEGORY.VERSION_MINOR_NUMBER }, Keys.KEY_VERSION_PRIMARY, new TableField[] { Version.VERSION.PROJECT_ID, Version.VERSION.VERSION_MAJOR_NUMBER, Version.VERSION.VERSION_MINOR_NUMBER }, true);
    public static final ForeignKey<UnitProcessRecord, ProjectRecord> FK_UNIT_PROCESS_PROJECT_ID = Internal.createForeignKey(UnitProcess.UNIT_PROCESS, DSL.name("FK_UNIT_PROCESS_PROJECT_ID"), new TableField[] { UnitProcess.UNIT_PROCESS.PROJECT_ID }, Keys.KEY_PROJECT_PRIMARY, new TableField[] { Project.PROJECT.PROJECT_ID }, true);
    public static final ForeignKey<UnitProcessRecord, VersionRecord> FK_UNIT_PROCESS_VERSION = Internal.createForeignKey(UnitProcess.UNIT_PROCESS, DSL.name("FK_UNIT_PROCESS_VERSION"), new TableField[] { UnitProcess.UNIT_PROCESS.PROJECT_ID, UnitProcess.UNIT_PROCESS.VERSION_MAJOR_NUMBER, UnitProcess.UNIT_PROCESS.VERSION_MINOR_NUMBER }, Keys.KEY_VERSION_PRIMARY, new TableField[] { Version.VERSION.PROJECT_ID, Version.VERSION.VERSION_MAJOR_NUMBER, Version.VERSION.VERSION_MINOR_NUMBER }, true);
