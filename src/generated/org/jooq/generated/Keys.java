...
public class Keys {
    ...
    public static final UniqueKey<FileRecord> KEY_FILE_UK_FILE_PROJECT_VERSION = Internal.createUniqueKey(File.FILE, DSL.name("KEY_FILE_UK_FILE_PROJECT_VERSION"), new TableField[] { File.FILE.PROJECT_ID, File.FILE.VERSION_NUMBER }, true);
    ...
    public static final UniqueKey<VersionRecord> KEY_VERSION_PRIMARY = Internal.createUniqueKey(Version.VERSION, DSL.name("KEY_VERSION_PRIMARY"), new TableField[] { Version.VERSION.PROJECT_ID, Version.VERSION.VERSION_NUMBER }, true);
    ...
    public static final ForeignKey<FileRecord, VersionRecord> FK_FILE_VERSION = Internal.createForeignKey(File.FILE, DSL.name("FK_FILE_VERSION"), new TableField[] { File.FILE.PROJECT_ID, File.FILE.VERSION_NUMBER }, Keys.KEY_VERSION_PRIMARY, new TableField[] { Version.VERSION.PROJECT_ID, Version.VERSION.VERSION_NUMBER }, true);
