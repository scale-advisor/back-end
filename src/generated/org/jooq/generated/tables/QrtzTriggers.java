...
import org.jooq.generated.tables.QrtzBlobTriggers.QrtzBlobTriggersPath;
import org.jooq.generated.tables.QrtzCronTriggers.QrtzCronTriggersPath;
import org.jooq.generated.tables.QrtzJobDetails.QrtzJobDetailsPath;
import org.jooq.generated.tables.QrtzSimpleTriggers.QrtzSimpleTriggersPath;
import org.jooq.generated.tables.QrtzSimpropTriggers.QrtzSimpropTriggersPath;
...
public class QrtzTriggers extends TableImpl<QrtzTriggersRecord> {
    ...
    /**
     * The reference instance of <code>scale_advisor.QRTZ_TRIGGERS</code>
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.SCHED_NAME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.TRIGGER_NAME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.TRIGGER_GROUP</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.JOB_NAME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.JOB_GROUP</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.DESCRIPTION</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.NEXT_FIRE_TIME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.PREV_FIRE_TIME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.PRIORITY</code>.
     */
    public final TableField<QrtzTriggersRecord, Integer> PRIORITY = createField(DSL.name("PRIORITY"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.TRIGGER_STATE</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.TRIGGER_TYPE</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.START_TIME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.END_TIME</code>.
     */
    public final TableField<QrtzTriggersRecord, Long> END_TIME = createField(DSL.name("END_TIME"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.CALENDAR_NAME</code>.
     */
    public final TableField<QrtzTriggersRecord, String> CALENDAR_NAME = createField(DSL.name("CALENDAR_NAME"), SQLDataType.VARCHAR(190), this, "");

    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.MISFIRE_INSTR</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_TRIGGERS.JOB_DATA</code>.
     */
    ...
    /**
     * Create an aliased <code>scale_advisor.QRTZ_TRIGGERS</code> table
     * reference
     */
    ...
    /**
     * Create a <code>scale_advisor.QRTZ_TRIGGERS</code> table reference
     */
    public QrtzTriggers() {
     ...
     * <code>scale_advisor.QRTZ_JOB_DETAILS</code> table.
     */
     ...
     * <code>scale_advisor.QRTZ_BLOB_TRIGGERS</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the
     * <code>scale_advisor.QRTZ_CRON_TRIGGERS</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the
     * <code>scale_advisor.QRTZ_SIMPLE_TRIGGERS</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the
     * <code>scale_advisor.QRTZ_SIMPROP_TRIGGERS</code> table
     */
