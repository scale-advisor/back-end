...
public class QrtzJobDetailsRecord extends UpdatableRecordImpl<QrtzJobDetailsRecord> {
     ...
     * Create a detached, initialised QrtzJobDetailsRecord
     */
    public QrtzJobDetailsRecord(org.jooq.generated.tables.pojos.QrtzJobDetails value) {
        super(QrtzJobDetails.QRTZ_JOB_DETAILS);
        ...
        if (value != null) {
            ...
            setJobClassName(value.getJobClassName());
            setIsDurable(value.getIsDurable());
            setIsNonconcurrent(value.getIsNonconcurrent());
            setIsUpdateData(value.getIsUpdateData());
            setRequestsRecovery(value.getRequestsRecovery());
