...
public class QrtzFiredTriggers extends TableImpl<QrtzFiredTriggersRecord> {
    ...
    /**
     * The reference instance of <code>scale_advisor.QRTZ_FIRED_TRIGGERS</code>
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.SCHED_NAME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.ENTRY_ID</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.TRIGGER_NAME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.TRIGGER_GROUP</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.INSTANCE_NAME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.FIRED_TIME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.SCHED_TIME</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.PRIORITY</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.STATE</code>.
     */
    ...
    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.JOB_NAME</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> JOB_NAME = createField(DSL.name("JOB_NAME"), SQLDataType.VARCHAR(190), this, "");

    /**
     * The column <code>scale_advisor.QRTZ_FIRED_TRIGGERS.JOB_GROUP</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> JOB_GROUP = createField(DSL.name("JOB_GROUP"), SQLDataType.VARCHAR(190), this, "");

    /**
     * The column
     * <code>scale_advisor.QRTZ_FIRED_TRIGGERS.IS_NONCONCURRENT</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> IS_NONCONCURRENT = createField(DSL.name("IS_NONCONCURRENT"), SQLDataType.VARCHAR(1), this, "");

    /**
     * The column
     * <code>scale_advisor.QRTZ_FIRED_TRIGGERS.REQUESTS_RECOVERY</code>.
     */
    public final TableField<QrtzFiredTriggersRecord, String> REQUESTS_RECOVERY = createField(DSL.name("REQUESTS_RECOVERY"), SQLDataType.VARCHAR(1), this, "");
    ...
    /**
     * Create an aliased <code>scale_advisor.QRTZ_FIRED_TRIGGERS</code> table
     * reference
     */
    ...
    /**
     * Create a <code>scale_advisor.QRTZ_FIRED_TRIGGERS</code> table reference
     */
